...
| Reset            | Kept name, theme, judges, weighting, projector sessions              | Restores the default show: name, short name, tagline, theme, font, reactions, judge panel (Judge 1–4 with fresh credentials), 50:50 weighting, GO policy, public text; revokes projector sessions and codes; deletes generated test data; sweeps stray R2 objects under the show's namespaces. |
